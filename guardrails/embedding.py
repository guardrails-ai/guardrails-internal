...
class OpenAIEmbedding(EmbeddingBase):
    ...
    def __init__(
        ...
        openai_api_key: Optional[str] = None,  # FIXME: Collapse with api_key
        ...
        self._model = model
        self.openai_api_key = openai_api_key  # FIXME: Collapse with api_key
    ...
    def _get_embedding(self, texts: List[str]) -> List[float]:
        ...
        #     api_key=self.openai_api_key, model=self._model, input=texts
        api_key = (
            self.api_key
